...
public class BusinessLogicIntegrationTest {
    ...
    public void setup() {
        ...
        founder1 = userRepository.save(User.builder().email("founder1@test.com").clerkId("clerk_f1").passwordHash("pwd").fullName("F1").role(Role.FOUNDER).accountStatus(AccountStatus.ACTIVE).build());
        founder2 = userRepository.save(User.builder().email("founder2@test.com").clerkId("clerk_f2").passwordHash("pwd").fullName("F2").role(Role.FOUNDER).accountStatus(AccountStatus.ACTIVE).build());
        talent1 = userRepository.save(User.builder().email("talent1@test.com").clerkId("clerk_t1").passwordHash("pwd").fullName("T1").role(Role.TALENT).accountStatus(AccountStatus.ACTIVE).build());
        talent2 = userRepository.save(User.builder().email("talent2@test.com").clerkId("clerk_t2").passwordHash("pwd").fullName("T2").role(Role.TALENT).accountStatus(AccountStatus.ACTIVE).build());
        ...
        startup1Uuid = startupService.createStartup(founder1.getClerkId(), req1).getUuid();
        ...
        startup2Uuid = startupService.createStartup(founder2.getClerkId(), req2).getUuid();
    }
    ...
    public void testScenario1_ApplyAndAccept() {
        ...
        String appUuid = talentApplicationService.apply(talent1.getClerkId(), UUID.fromString(startup1Uuid), appReq).getUuid();
        ...
        // Founder accepts
        founderApplicationService.updateApplicationStatus(founder1.getClerkId(), UUID.fromString(appUuid), ApplicationStatus.ACCEPTED);
    ...
    public void testScenario2_RejectAndReapply() {
        ...
        // Founder rejects
        founderApplicationService.updateApplicationStatus(founder1.getClerkId(), UUID.fromString(appUuid), ApplicationStatus.REJECTED);
        
        // Talent applies again!
        ApplicationRequest appReq2 = new ApplicationRequest();
        appReq2.setIntroduction("Attempt 2");
        talentApplicationService.apply(talent1.getClerkId(), UUID.fromString(startup1Uuid), appReq2);
    ...
    public void testScenario3_AcceptThenRemoveThenReapply() {
        ...
        workspaceService.removeMember(founder1.getClerkId(), startup.getUuid(), talent1.getUuid());
        ...
        // Talent applies again
        talentApplicationService.apply(talent1.getClerkId(), UUID.fromString(startup1Uuid), appReq);
    ...
    public void testScenario4_IsolationBetweenWorkspaces() {
        ...
        String app1Uuid = talentApplicationService.apply(talent1.getClerkId(), UUID.fromString(startup1Uuid), appReq).getUuid();
        String app2Uuid = talentApplicationService.apply(talent1.getClerkId(), UUID.fromString(startup2Uuid), appReq).getUuid();
        
        founderApplicationService.updateApplicationStatus(founder1.getClerkId(), UUID.fromString(app1Uuid), ApplicationStatus.ACCEPTED);
        founderApplicationService.updateApplicationStatus(founder2.getClerkId(), UUID.fromString(app2Uuid), ApplicationStatus.ACCEPTED);
        ...
        workspaceService.removeMember(founder1.getClerkId(), startup1.getUuid(), talent1.getUuid());
