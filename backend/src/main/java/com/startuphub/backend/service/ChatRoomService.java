...
import com.startuphub.backend.service.storage.UploadType;
...
@Transactional
    public ChatRoomResponse updateGroupIcon(String clerkId, UUID startupUuid, UUID roomUuid, MultipartFile file) {
        ...
        if (file == null || file.isEmpty()) {
            ...
            String fileUrl = storageService.save(file, StorageContext.forGroupIcon(startupUuid, roomUuid, iconUuid));
