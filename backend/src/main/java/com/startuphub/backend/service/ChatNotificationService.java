...
public class ChatNotificationService {
    ...
    @Transactional
    public void deleteAllNotifications(String clerkId) {
        User user = userRepository.findByClerkId(clerkId)
                .orElseThrow(() -> new ResourceNotFoundException("User not found"));
    ...
    public ChatNotificationResponse toDto(ChatNotification notif) {
        ...
        return ChatNotificationResponse.builder()
                ...
                .senderUuid(notif.getSender() != null ? notif.getSender().getUuid().toString() : null)
                .content(notif.getContent())
                .createdAt(notif.getMessage() != null ? notif.getMessage().getCreatedAt() : notif.getCreatedAt())
                .isRead(notif.isRead())
