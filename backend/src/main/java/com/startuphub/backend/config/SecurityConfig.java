...
public class SecurityConfig {
    ...
    @org.springframework.beans.factory.annotation.Value("${cors.allowed-origins:http://localhost:5173,http://localhost:1026}")
        ...
        http
            ...
            .oauth2ResourceServer(oauth2 -> oauth2
                .bearerTokenResolver(request -> {
                    ...
                    // JWT Only. No cookie fallback.
                    return null;
                })
                .jwt(jwt -> jwt.jwtAuthenticationConverter(customJwtAuthenticationConverter(userRepository)))
            );
