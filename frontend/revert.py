            ...
            <div className="flex items-center justify-between px-6 pt-6 pb-2 relative z-10">
              <div>
                <h3 className="text-white/90 font-semibold flex items-center gap-2 tracking-wide">
                  <Sparkles className="w-4 h-4 text-cyan-400" /> Intelligence
                </h3>
              </div>
              <button 
                onClick={onClose}
                  ...
                  <div className="h-[90px] flex flex-col items-center justify-center text-center w-full">
                    ...
                    {state === 'recording' && (
                      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full">
                        ...
                        <div className="text-cyan-400/90 text-xs font-bold uppercase tracking-[0.2em] animate-pulse">
                          Recording
                        </div>
                      </motion.div>
                    )}
              ...
              {state === 'ready' && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col py-4 mt-2">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button 
                      onClick={handleSend}
                      className="flex-[2] py-3.5 flex items-center justify-center gap-2 rounded-2xl bg-cyan-500 hover:bg-cyan-400 transition-all text-[#0c1015] font-bold text-sm shadow-[0_0_20px_rgba(34,211,238,0.4)] hover:shadow-[0_0_30px_rgba(34,211,238,0.6)] hover:-translate-y-0.5"
                    >
