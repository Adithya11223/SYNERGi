    ...
    <div className="space-y-12 pb-12">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-6">
          {/* Founder 1 */}
          <div className="glass-card rounded-2xl p-3 sm:p-8 border flex flex-col items-center text-center interactive-glass">
            <div className="w-14 h-14 sm:w-24 sm:h-24 rounded-full bg-primary/10 border-2 sm:border-4 border-background shadow-lg overflow-hidden mb-3 sm:mb-6 flex items-center justify-center shrink-0">
              <span className="text-lg sm:text-3xl font-bold text-primary">VK</span>
            </div>
            <h4 className="text-xs sm:text-xl font-bold text-foreground mb-1 leading-tight sm:leading-normal">VEMULA KARANTHEJ</h4>
            <p className="text-[10px] sm:text-sm text-primary font-medium mb-2 sm:mb-4">Founder</p>
            <p className="text-[9px] sm:text-sm text-muted-foreground leading-tight sm:leading-normal">
          ...
          <div className="glass-card rounded-2xl p-3 sm:p-8 border flex flex-col items-center text-center interactive-glass">
            <div className="w-14 h-14 sm:w-24 sm:h-24 rounded-full bg-primary/10 border-2 sm:border-4 border-background shadow-lg overflow-hidden mb-3 sm:mb-6 flex items-center justify-center shrink-0">
              <span className="text-lg sm:text-3xl font-bold text-primary">AA</span>
            </div>
            <h4 className="text-xs sm:text-xl font-bold text-foreground mb-1 leading-tight sm:leading-normal">ANKUNCHE ADITHYA</h4>
            <p className="text-[10px] sm:text-sm text-primary font-medium mb-2 sm:mb-4">Founder</p>
            <p className="text-[9px] sm:text-sm text-muted-foreground leading-tight sm:leading-normal">
        ...
        <section className="space-y-6">
          ...
          <div className="glass-card rounded-2xl p-8 border flex flex-col items-center justify-center text-center h-[280px]">
            ...
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_15px_rgba(var(--primary),0.3)] interactive-glass-button w-full sm:w-auto"
            >
