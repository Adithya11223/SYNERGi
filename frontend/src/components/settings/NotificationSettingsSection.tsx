  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-1 md:space-y-4">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">Direct Messages</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-t-xl md:rounded-none border-b border-white/5 md:border-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
              <Switch checked={settings.notifyDirectMessagesPush} onCheckedChange={(v) => settings.updateSetting('notifyDirectMessagesPush', v)} />
            </div>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-b-xl md:rounded-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Email Notifications</Label>
              <Switch checked={settings.notifyDirectMessagesEmail} onCheckedChange={(v) => settings.updateSetting('notifyDirectMessagesEmail', v)} />
            </div>
          </div>
          
          <div className="space-y-1 md:space-y-4 pt-4 md:pt-4 border-t border-border">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">Group Mentions</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-t-xl md:rounded-none border-b border-white/5 md:border-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-1 md:space-y-4">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">Incoming Voice Calls</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-xl md:rounded-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
          ...
          <div className="space-y-1 md:space-y-4 pt-4 md:pt-4 border-t border-border">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">Scheduled Meetings</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-t-xl md:rounded-none border-b border-white/5 md:border-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-1 md:space-y-4">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">Workspace Invitations</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-t-xl md:rounded-none border-b border-white/5 md:border-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
          ...
          <div className="space-y-1 md:space-y-4 pt-4 md:pt-4 border-t border-border">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">Task Assignments</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-t-xl md:rounded-none border-b border-white/5 md:border-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-1 md:space-y-4">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">New Matches</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-t-xl md:rounded-none border-b border-white/5 md:border-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
          ...
          <div className="space-y-1 md:space-y-4 pt-4 md:pt-4 border-t border-border">
            <h4 className="text-sm md:text-sm font-semibold text-foreground dark:text-gray-100 mb-2 md:mb-4 px-2 md:px-0">Application Updates</h4>
            <div className="flex items-center justify-between px-4 md:px-0 md:ml-4 py-3 md:py-0 bg-white/5 md:bg-transparent rounded-t-xl md:rounded-none border-b border-white/5 md:border-none">
              <Label className="font-medium md:font-normal text-foreground md:text-muted-foreground text-base md:text-sm">Push Notifications</Label>
