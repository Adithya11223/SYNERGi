  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed top-8 left-1/2 -translate-x-1/2 z-[999999] bg-background border border-border shadow-2xl rounded-2xl p-4 flex flex-col items-center w-[90vw] sm:w-auto sm:min-w-[360px] max-w-[400px]"
      >
