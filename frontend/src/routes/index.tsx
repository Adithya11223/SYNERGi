...
const GlobalTodoList = lazy(() => import("@/pages/shared/GlobalTodoList"));
const GlobalNotes = lazy(() => import("@/pages/shared/GlobalNotes"));
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: "todo", element: withSuspense(GlobalTodoList) },
              { path: "notes", element: withSuspense(GlobalNotes) },
