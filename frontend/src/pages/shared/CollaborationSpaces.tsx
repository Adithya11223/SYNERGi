...
export default function CollaborationSpaces() {
  ...
  if (loading) {
    return (
      <div className="p-2 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-4 sm:space-y-8">
  ...
  if (errorMsg !== null) {
    return (
      <div className="p-2 sm:p-6 lg:p-8 max-w-7xl mx-auto flex flex-col items-center justify-center py-24 text-center">
        <div className="h-16 w-16 rounded-full bg-destructive/10 flex items-center justify-center mb-6">
          <ShieldAlert className="h-8 w-8 text-destructive" />
        </div>
        <h3 className="text-xl font-bold tracking-tight mb-2 text-slate-900 dark:text-white">Could not load workspaces</h3>
        <p className="text-slate-900 dark:text-slate-600 dark:text-white/60 max-w-sm mb-4">There was a problem fetching your collaboration spaces. Please try again.</p>
  ...
  return (
    <div className="p-2 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-4 sm:space-y-8">
      <div>
        <h2 className="text-3xl font-bold tracking-tight flex items-center gap-2 text-slate-900 dark:text-white"><Building2 className="w-8 h-8 text-primary" /> Collaboration Spaces</h2>
        <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 mt-2">
          {user?.role === "FOUNDER" 
              ...
              <div className="p-4 sm:p-6 flex-1 flex flex-col relative z-10">
                ...
                <div className="flex justify-between items-start mb-5">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-slate-900 dark:text-white leading-tight group-hover:text-primary transition-colors duration-300">
                        {ws.startupName}
                      </h3>
                ...
                {/* Info List */}
                <div className="space-y-4 md:space-y-3.5 mb-6 flex-1 border-t border-b border-white/5 py-5 md:py-4">
                  ...
                  <div className="flex items-center justify-between text-base md:text-sm">
                    <span className="text-slate-400 flex items-center gap-2">
                      <Rocket className="w-5 h-5 md:w-4 md:h-4 text-accent/70 group-hover:scale-110 transition-transform duration-300" />
                      Role
                    </span>
                  ...
                  <div className="flex items-center justify-between text-base md:text-sm">
                    <span className="text-slate-400 flex items-center gap-2">
                      <Activity className="w-5 h-5 md:w-4 md:h-4 text-green-400/60 group-hover:scale-110 transition-transform duration-300" />
                      Last Activity
                    </span>
                ...
                {/* Link Action */}
                <Link to={`${basePath}/workspace/${ws.startupUuid}`} className="block w-full mt-auto">
                  <Button className="w-full h-12 md:h-11 rounded-2xl md:rounded-xl bg-primary/25 hover:bg-primary border border-primary/30 hover:border-transparent text-primary hover:text-primary-foreground font-semibold transition-all duration-300 flex items-center justify-center gap-2 group/btn">
                    Open Workspace 
