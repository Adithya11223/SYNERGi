...
export default function WorkspacePlaceholder() {
  ...
  return (
    <div className="h-[70vh] flex flex-col items-center justify-center max-w-lg mx-auto text-center space-y-6">
      ...
      <div>
        <h2 className="text-3xl font-bold tracking-tight mb-3 text-slate-900 dark:text-white">{title}</h2>
        <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 text-lg mb-8">{desc}</p>
      </div>
