    ...
    <div className="min-h-[100dvh] bg-transparent flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 z-10 mt-12 mb-24">
        ...
        >
          ...
          <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 max-w-2xl mx-auto leading-relaxed">
        ...
        >
          <div className="flex flex-col items-center text-center p-6 rounded-2xl glass-card border shadow-sm">
            ...
            <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 text-sm">AI-driven connections between startups and top-tier talent.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6 rounded-2xl glass-card border shadow-sm">
            ...
            <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 text-sm">Post ideas, manage applicants, and hire the perfect fit.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6 rounded-2xl glass-card border shadow-sm">
            ...
            <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 text-sm">Seamless workflow to get your profile ready in minutes.</p>
          </div>
        </motion.div>
      </main>
    </div>
