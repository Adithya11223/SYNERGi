          ...
          <CardContent>
            {success ? (
              ...
              >
                ...
                <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 text-sm">{type === "login" || type === "login_mfa" ? "Redirecting to your dashboard..." : "Please login to continue."}</p>
              </motion.div>
            ) : (
