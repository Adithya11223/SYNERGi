  ...
  return (
    <div className="max-w-4xl mx-auto p-6 lg:p-8 space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Apply to {startup.name}</h1>
          <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 mt-1">Convince the founder that you're the perfect fit.</p>
        </div>
      </div>
