...
export default function TalentApplications() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-5xl mx-auto space-y-8">
      <div>
        <h2 className="text-3xl font-bold tracking-tight flex items-center gap-2 text-slate-900 dark:text-white"><Briefcase className="w-8 h-8 text-primary" /> My Applications</h2>
        <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 mt-2">Track the status of your startup applications.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center border rounded-2xl glass-card border-dashed">
          ...
          <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 max-w-md mx-auto mb-8">You haven't applied to any startups. Discover exciting ideas and send your first application!</p>
