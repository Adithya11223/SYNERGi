        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-end gap-6">
          ...
          <div className="flex-1 pb-2">
            <div className="flex flex-wrap items-center gap-3 mb-2">
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white">{startup.name}</h1>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold flex items-center gap-2 text-slate-900 dark:text-white"><Target className="text-primary"/> About the Idea</h2>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {startup.vision && (
                <div className="glass-card border rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 text-sm">{startup.vision}</p>
                </div>
              )}
              {startup.mission && (
                <div className="glass-card border rounded-xl p-6 shadow-sm">
                  <h3 className="font-semibold text-lg flex items-center gap-2 mb-3"><Rocket className="w-5 h-5 text-primary" /> Mission</h3>
                  <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 text-sm">{startup.mission}</p>
                </div>
              )}
            </div>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold flex items-center gap-2 text-slate-900 dark:text-white"><TrendingUp className="text-primary"/> Progress & Roadmap</h2>
