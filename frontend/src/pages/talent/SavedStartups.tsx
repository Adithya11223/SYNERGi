  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight flex items-center gap-2 text-slate-900 dark:text-white"><Bookmark className="w-8 h-8 text-primary" /> Saved Startups</h2>
          <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 mt-2">Startups you have bookmarked for later review or to apply to.</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center border rounded-2xl glass-card border-dashed">
          ...
          <p className="text-slate-900 dark:text-slate-600 dark:text-white/80 max-w-md mx-auto mb-8">You haven't bookmarked any startup ideas yet. Start exploring and save the ones that catch your eye!</p>
          <Link to="/talent/startups">
